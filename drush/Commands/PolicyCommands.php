...
class PolicyCommands extends DrushCommands {
  ...
  public function configImportValidate(CommandData $commandData) {
    ...
    if ($commandData->input()->getOption('partial') === FALSE) {
      throw new \Exception(dt('Per !file, you must use `--partial` when importing configuration. This will prevent the deletion of entity bundles (e.g. registration types).', ['!file' =>  __FILE__]));
    }
  }
