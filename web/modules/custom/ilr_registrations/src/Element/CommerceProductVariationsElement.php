 ...
 * @code
 * $form['variation'] = [
 *   '#type' => 'commerce_product_variations',
 ...
 * @endcode
 *
 * @FormElement("commerce_product_variations")
 *
 * @see \Drupal\Core\Render\Element\FormElement
 * @see
 * https://api.drupal.org/api/drupal/core%21lib%21Drupal%21Core%21Render%21Element%21FormElement.php/class/FormElement
 * @see \Drupal\Core\Render\Element\RenderElement
 * @see
 * https://api.drupal.org/api/drupal/namespace/Drupal%21Core%21Render%21Element
 * @see
 * \Drupal\commerce_product_variations\Element\CommerceProductVariationsElement
 */
class CommerceProductVariationsElement extends FormElement {
  ...
  /**
   * Processes a 'commerce_product_variations' element.
   */
